  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: 24 }}>
      <div style={{ padding: 24, borderRadius: 20, background: "#0f172a", border: "1px solid #1e293b" }}>
        ...
        <div style={{ marginTop: 24, padding: 16, borderRadius: 16, background: "#111827" }}>
          <h2>Planned admin modules</h2>
          <ul>
            <li>Schedule entry and CSV import</li>
            <li>Roster management</li>
            <li>Stats entry and CSV import</li>
            <li>Announcements</li>
            <li>PDF and image uploads</li>
          </ul>
        </div>
      </div>
    </main>
