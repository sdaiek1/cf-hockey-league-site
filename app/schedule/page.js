...
function parseGameTimeToMinutes(
  timeString = ""
) {
...
function buildGoogleCalendarUrl(
  ...
  const title =
    `${homeTeam} vs ${awayTeam} — Cold Fusion Draft League`;

  const details = [
    "Cold Fusion Draft League game",
    "",
...
export default async function SchedulePage({
  ...
  const requestedTeam =
    typeof resolvedSearchParams?.team ===
    "string"
  ...
  const calendarButton = {
    ...
    boxShadow:
      "0 8px 20px rgba(34,211,238,0.18)",
  };
    ...
    >
      <style>{`
        ...
        @media (max-width: 760px) {
          ...
          .schedule-team {
            ...
            border:
              1px solid rgba(34,211,238,0.08) !important;
      ...
      >
        ...
        >
          ...
          >
            Upcoming games and league
            schedule at Codey Arena.
          </p>
