...
export default async function StatsPage({
  ...
  if (
    ...
    if (
      ...
      playersError =
        playersFetchError.message;
    } else {
      /*
        Only keep players assigned
        to one of the four Draft
        League teams.
      */
      players = (
        playersData || []
        ...
        >
          ...
          {playersError ? (
            ...
            >
              {selectedTeam ===
              "all"
                ? "No Draft League player stats yet."
